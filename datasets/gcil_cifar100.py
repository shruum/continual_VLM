...
class GCILCIFAR100(ContinualDataset):
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        trainset = MyCIFAR100(os.path.join(self.args.dataset_dir, 'CIFAR100'), train=True, download=True, transform=self.TRANSFORM)
        testset = MyCIFAR100(os.path.join(self.args.dataset_dir, 'CIFAR100'), train=False, download=True, transform=test_transform)
        ...
        self.sampling_seeds = [np.random.randint(0, 10000) for _ in range(GCILCIFAR100.N_TASKS)]
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyCIFAR100(os.path.join(self.args.dataset_dir, 'CIFAR100'), train=True, download=True, transform=transform)
        test_dataset = CIFAR100(os.path.join(self.args.dataset_dir, 'CIFAR100'), train=False, download=True, transform=test_transform)
