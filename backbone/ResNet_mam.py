...
class ResNetMam(MammothBackbone):
    """
...
def resnet18mam(nclasses: int, nf: int = 64) -> ResNetMam:
    """
    ...
    Returns:
        ResNet network
    """
    return ResNetMam(BasicBlock, [2, 2, 2, 2], nclasses, nf)


def resnet34man(nclasses: int, nf: int = 64) -> ResNetMam:
    """
    ...
    Returns:
        ResNet network
    """
    return ResNetMam(BasicBlock, [3, 4, 6, 3], nclasses, nf)

def resnet50mam(nclasses: int, nf: int=64):
    return ResNetMam(Bottleneck, [3,4,6,3], nclasses, nf)