...
class CLSER(ContinualModel):
    ...
    def __init__(self, backbone, loss, args, transform):
        ...
        # Additional models
        self.addit_models = ['stable_model', 'plastic_model']
    ...
    def observe(self, inputs, labels, not_aug_inputs):
        ...
        if not self.buffer.is_empty():
            ...
            if hasattr(self, 'writer'):
                self.writer.add_scalar(f'Task {self.task}/l_cons', l_cons.item(), self.iteration)
                self.writer.add_scalar(f'Task {self.task}/l_reg', l_reg.item(), self.iteration)
        ...
        # Log values
        if hasattr(self, 'writer'):
            self.writer.add_scalar(f'Task {self.task}/ce_loss', ce_loss.item(), self.iteration)
            self.writer.add_scalar(f'Task {self.task}/loss', loss.item(), self.iteration)
    ...
    def end_task(self, dataset):
        ...
        # Evaluate the additional models
        self.eval_addit_models(dataset)
